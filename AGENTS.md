...
- `tests/test_no_trade_monitor.py` — 11 tests for MonitorIdleStreakTask + SimResult streak surface + adapter round-trip. Guards the "no systematic no-trade periods" contract (AGENTS.md 2b).
...
- `AGENTS.md` — this file; keep test counts and rule set current
