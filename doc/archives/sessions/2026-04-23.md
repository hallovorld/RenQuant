...
IC went down, APY went up. Hourly features add signal that averaged-IC doesn't capture. Full diagnosis in `doc/experiments/panel-training-runs.md` (2026-04-23 late PT entry).
...
8. **Env doc** (`c9ee50b`). `requirements.lock.txt` (310 packages) + `doc/ops/environment.md`.
...
## Machine envelope (from `doc/ops/environment.md`)
