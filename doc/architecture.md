...
**Stage 3: EXECUTE** — if model says "buy" and all constraints pass, enter position. Max 3 concurrent positions.
...
- **Sector guard**: max 1 concurrent position per sector (prevents all 3 slots being correlated tech names)
