...
Writes: ctx.ranked (sorted list of CandidateResult)
"""
...
class BlendScoresTask(Task):
    """Apply blend weights to each candidate's rank_score and rs_score."""
...
class SortCandidatesTask(Task):
    """Sort blended candidates by score descending → ctx.ranked."""
