...
from adapters.sim_metrics import (  # noqa: F401,E402
    _annual_net_equity_curve,
    _finite_attr_values,
    _finite_float,
    _mean_or_nan,
    _quantile_or_nan,
...
class SimAdapter:
    ...
    def _corr_leakage_present(as_of_date, backtest_start) -> bool:
        from adapters.sim_leakage_guards import corr_leakage_present  # noqa: PLC0415
        return corr_leakage_present(as_of_date, backtest_start)

    @staticmethod
    def _gmm_leakage_present(artifact, backtest_start, as_of_extractor) -> bool:
        from adapters.sim_leakage_guards import gmm_leakage_present  # noqa: PLC0415
        return gmm_leakage_present(artifact, backtest_start, as_of_extractor)
