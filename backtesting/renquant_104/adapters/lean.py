...
_PANEL_LOOKBACK     = 520
# ── LEAN account / buying-power snapshots — EXTRACTED to lean_account.py ─
# (eng plan S2 item 5 decomposition slice 2, 2026-06-13.)
from adapters.lean_account import (  # noqa: F401,E402
    _BUYING_POWER_ALIASES,
    _BUYING_POWER_NMBP,
    _BUYING_POWER_SETTLED,
    _finite_attr_float,
    _lean_buying_power_snapshot,
...
# ── LEAN order-ticket execution — EXTRACTED to lean_order.py ────────────
# (eng plan S2 item 5 decomposition slice 3, 2026-06-13.) _positive_finite_price
# moves with it (the execution path's fill-price validator); re-exported so the
# price-resolution helpers above keep resolving it by name.
from adapters.lean_order import (  # noqa: F401,E402
    _lean_order_execution,
    _lean_ticket_float,
    _lean_ticket_status_text,
    _positive_finite_price,
)


# ── LEAN trace builders — EXTRACTED to lean_trace.py ────────────────────
# (eng plan S2 item 5 decomposition slice 1, 2026-06-13.)
from adapters.lean_trace import (  # noqa: F401,E402
    _lean_attempt_action,
