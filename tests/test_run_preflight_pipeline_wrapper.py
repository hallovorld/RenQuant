...
Contract preserved:
  1. Returned list has 19 entries in ``_LEGACY_CHECK_ORDER`` order
...
class TestRunPreflightWrapperContract:
    ...
    def test_returns_nineteen_results(self, tmp_path):
...
class TestRunPreflightOrderingInvariant:
    ...
    def test_legacy_order_size_matches_check_count(self):
        ...
        # Today's tally: 19 checks in the pipeline.
        assert len(_LEGACY_CHECK_ORDER) == 19
