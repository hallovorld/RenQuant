...
|------|----------|------------|------------------------|
| `manual` | No-op (generic score_rules at construction) | Multi-indicator threshold voting | Binary signal as float proxy |
