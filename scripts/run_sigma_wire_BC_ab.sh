#!/bin/bash
# σ-wire per-regime A/B runner: 8-window dense panel, sigma_on only (reuses
...
BATCH="sigma_wire_BC_2026-05-17"
mkdir -p logs/reeval_queue data/logs/monitor

LABEL="sigma_on_BEAR_CHOPPY_2026-05-17"
...
if (( n == 8 )); then
  ...
  OUT_MD="data/logs/reeval_results/sigma_wire_BC_2026-05-17_rigorous.md"
