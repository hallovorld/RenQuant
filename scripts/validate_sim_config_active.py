...
ACTIVE_PATHS: list[tuple[str, str]] = [
    ...
    # ── benchmark beta sleeve (task_benchmark_sleeve.py) ────────────────
    ("portfolio.benchmark_sleeve.enabled",                 "task_benchmark_sleeve.py:BenchmarkSleeveTask"),
    ("portfolio.benchmark_sleeve.ticker",                  "task_benchmark_sleeve.py:benchmark_sleeve_ticker"),
    ("portfolio.benchmark_sleeve.exclude_from_alpha_pipeline", "task_benchmark_sleeve.py:exclude_benchmark_sleeve_from_alpha"),
    ("portfolio.benchmark_sleeve.target_exposure",         "task_benchmark_sleeve.py:_target_exposure_for_regime"),
    ("portfolio.benchmark_sleeve.target_exposure_by_regime.*", "task_benchmark_sleeve.py:_target_exposure_for_regime"),
    ("portfolio.benchmark_sleeve.max_sleeve_pct",          "task_benchmark_sleeve.py:BenchmarkSleeveTask"),
    ("portfolio.benchmark_sleeve.rebalance_band_pct",      "task_benchmark_sleeve.py:BenchmarkSleeveTask"),
    ("portfolio.benchmark_sleeve.min_trade_pct",           "task_benchmark_sleeve.py:BenchmarkSleeveTask"),
    ("portfolio.benchmark_sleeve.turnover_penalty",        "task_benchmark_sleeve.py:solve_benchmark_sleeve_target"),
    ("portfolio.benchmark_sleeve.respect_buy_gates",       "task_benchmark_sleeve.py:BenchmarkSleeveTask._emit_buy"),
    ("portfolio.benchmark_sleeve.fund_alpha_from_sleeve",  "task_benchmark_sleeve.py:benchmark_sleeve_alpha_funding_capacity"),
