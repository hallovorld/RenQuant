...
if RENQUANT_SUPPRESS_PREFLIGHT_NTFY=1 \
    ...
    FULL_RC=$?
    cat "$FULL_RUN_LOG"
    BUY_SIDE_PREFLIGHT_PATTERN="P-WF-GATE|P-REGIME-IC|P-CONFIG-FP|P-SECTOR-MAP|P-PANEL-CONTRACT|P-CALIBRATOR-HEALTH|P-CALIBRATOR-FLAT-REGION|P-FEATURE-COVER|P-WATCHLIST|P-MODEL-ARTIFACT|P-PREFLIGHT-IMPORT|P-PREFLIGHT-EXCEPTION"
