...
CHECKS: tuple[Check, ...] = (
    ...
    Check(
        ...
        required=(
            ...
            'renquant_subrepo_pythonpath "$SUBREPO_ROOT" renquant-orchestrator',
    ...
    Check(
        name="live_multirepo_delegates_to_orchestrator_bridge",
        ...
        forbidden=(
            'importlib.import_module("live.runner")',
            "from subrepo_paths import resolve_subrepo_root",
            "renquant_pipeline.kernel.panel_pipeline.job_panel_scoring",
        ),
    ),
    Check(
        name="daily_multirepo_delegates_to_orchestrator_bridge",
        ...
        required=(
            ...
            "return _bridge._with_pinned_strategy_config(argv, repo_root=REPO)",
            "return _bridge.bootstrap_multirepo(",
            'return _bridge.main(mode="daily", repo_root=REPO)',
        ),
        forbidden=(
            'importlib.import_module("live.runner")',
            "from subrepo_paths import resolve_subrepo_root",
    ...
    Check(
        ...
        required=(
            "test_strategy_subrepo_configs_are_available_from_lock_pin",
            'git", "-C", str(repo), "show"',
